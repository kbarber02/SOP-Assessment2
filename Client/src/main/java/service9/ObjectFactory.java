 ...
 * generated in the service9 package. 
...
public class ObjectFactory {
    ...
    private final static QName _FileNotFoundException_QNAME = new QName("http://service9/", "FileNotFoundException");
    private final static QName _JAXBException_QNAME = new QName("http://service9/", "JAXBException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: service9
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service9/", name = "FileNotFoundException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service9/", name = "JAXBException")
